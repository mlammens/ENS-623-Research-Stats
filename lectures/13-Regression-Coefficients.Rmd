...
* Introduce the equations for estimating simple linear regression coefficients
* Identify that regression coefficients are stastics that are t-distributed
...
It's the Mean Sums of Squares Residuals (see figure in [Section 12 notes](https://mlammens.github.io/ENS-623-Research-Stats/lectures/12-Linear-Regression.html#model-evalutation)).
