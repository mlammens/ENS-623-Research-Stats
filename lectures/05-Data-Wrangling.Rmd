---
title: "Introductory Data Wrangling"
...
* Practice sub-setting a data set using functions `select` and `filter`
* Practice calculating summaries of a data set using functions `group_by` and `summarize`
...
making tabular data wrangling easier. It pairs nicely with **`tidyr`** which enables you to swiftly convert between different data formats for plotting and analysis.
