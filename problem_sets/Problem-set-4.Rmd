---
title: "ENS 623 - Spring 2020 - Problem Set 4"
...
**`[last name]_ENS623_SP20_PS4.Rmd`**

For example, 

`Lammens_ENS623_SP20_PS4.Rmd`

#### Grading note

This is a single problem worth 25 points, but partial credit will be given.

Write an R script to simulate the combinations of colors that would have been possible from your bag of M&Ms assuming the company-stated color distribution (23% blue, 14% brown, 16% green, 20% orange, 13% red, 14% yellow) and use this script to calculate the probability of obtaining the combination in your bag. 
...
## I want to "sample" a bag of MMs - here my bag has 15 M&Ms in it. 
